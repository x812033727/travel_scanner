"""Guarded evidence-subset follow-up of the exact 2026-09-09 hotel snapshot.
...
BASELINE_CAPTURED_AT = "2026-09-08 16:20:20.550803+00:00"
...
def baseline_data(path):
    ...
    if sum(k[0] == "product" for k in pending) != 20 or len(pending) != 174:
        raise ValueError("Expected exactly 20 pending products and 154 pending options")
