...
USAGE_OPERATIONS = (
    ...
    # Nudging one day of an existing trip from the intent bar. Seeded at 0 uses
    # by migration 0040 so a day refinement ships free and its price stays an
    # admin dial rather than a deploy. A whole-trip intent is a full re-plan and
    # charges ai_itinerary_generation instead — see trips/intents.py.
    "ai_itinerary_refine",
