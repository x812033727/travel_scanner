...
DISH_CATEGORIES: dict[str, tuple[str, ...]] = {
    ...
    "jp-okinawa-soba": ("noodles",),
    "jp-goya-champuru": ("home-style",),
    "jp-rafute": ("home-style",),
    "jp-taco-rice": ("rice-dishes", "street-food"),
    "jp-sata-andagi": ("desserts-sweets", "street-food"),
    "jp-naporitan": ("noodles", "home-style"),
    "jp-doria": ("rice-dishes",),
    "jp-shumai": ("dim-sum-dumplings",),
    "jp-shirasu-don": ("rice-dishes", "seafood"),
    "jp-kenchin-jiru": ("hotpot-soup", "home-style"),
    ...
    "kr-dwaeji-gukbap": ("hotpot-soup", "rice-dishes"),
    "kr-milmyeon": ("noodles",),
    "kr-gomtang": ("hotpot-soup", "rice-dishes"),
    "kr-heukdwaeji": ("bbq-grill",),
    "kr-gogi-guksu": ("noodles",),
    "kr-jjim-galbi": ("home-style",),
    "kr-makchang": ("bbq-grill",),
