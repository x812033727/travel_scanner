...
MERCHANT_AREA_KEYS: dict[str, str] = {
    ...
    "busan-songjeong-samdae-gukbap": "seomyeon",
    "jeju-donsadon": "jeju-city",
    "jeju-kim-man-bok": "jeju-city",
    "jeju-guksu-madang": "jeju-city",
...
MERCHANT_SEEDS: tuple[MerchantSeed, ...] = (
    ...
    # Production already holds this shop, published by an administrator under this slug;
    # the seeder adopts a row whose slug matches and adds only the dish link.
    _m(
        "seoul",
        "KR",
        "hadongkwan-main-store",
        "Hadongkwan",
        "하동관",
        ("kr-gomtang",),
        10,
    ...
    # Also an administrator's published row in production, adopted the same way.
    _m(
        "busan",
        "KR",
    ...
    _m(
        ...
        "Donsadon",
        "돈사돈",
        ("kr-kimchi", "kr-samgyeopsal", "kr-heukdwaeji"),
        1,
    ),
    ...
    _m("daegu", "KR", "palgong-makchang", "Palgong Makchang", "팔공막창", ("kr-makchang",), 7),
...
MERCHANT_DIRECT_SOURCE_SEEDS: tuple[MerchantDirectSourceSeed, ...] = (
    ...
    _official_listing(
        "seoul-gwanghwamun-gukbap",
        "Korea Tourism Organization listing for Gwanghwamun Gukbap",
        "https://english.visitkorea.or.kr/svc/contents/contentsView.do?vcontsId=191554",
    ),
    _official_listing(
        "seoul-hadongkwan-main-store",
        "Visit Seoul listing for Hadongkwan",
        "https://english.visitseoul.net/City-Hall-Area/Hadonggwan/ENP005614",
    ),
    _official_listing(
        "busan-songjeong-samdae-gukbap",
        "Visit Busan listing for Songjeong Samdae Gukbap",
        "https://www.visitbusan.net/kr/index.do?menuCd=DOM_000000201002002001&uc_seq=1616&lang_cd=ko",
    ),
    _official_listing(
        "jeju-guksu-madang",
        "Visit Jeju listing for Guksu Madang main branch",
        "https://www.visitjeju.net/kr/detail/view?contentsid=CNTS_000000000019644",
    ),
    _official_listing(
        "daegu-dongwon-jjimgalbi",
        "Daegu city food guide listing for Dongwon Jjimgalbi",
        "https://www.daegufood.go.kr/kor/food/food.asp?idx=364&gotoPage=1&snm=9&ta=5",
    ),
    _official_listing(
        "daegu-palgong-makchang",
        "Daegu city food guide listing for Palgong Makchang",
        "https://www.daegufood.go.kr/kor/food/food.asp?idx=1603&gotoPage=1&snm=9&ta=5",
    ),
    _official_listing(
        "jeonju-hankook-jib",
