...
OAUTH_ERROR_DETAILS: dict[Locale, dict[str, str]] = {
    "en": {
        ...
        "affiliate_destination_not_found": "That destination could not be found",
        "affiliate_link_unavailable": "That partner link is temporarily unavailable",
    ...
    "ja": {
        ...
        "affiliate_destination_not_found": "目的地が見つかりません",
        "affiliate_link_unavailable": "提携リンクを一時的に利用できません",
    ...
    "ko": {
        ...
        "affiliate_destination_not_found": "목적지를 찾을 수 없습니다",
        "affiliate_link_unavailable": "제휴 링크를 일시적으로 사용할 수 없습니다",
    ...
    "zh-CN": {
        ...
        "affiliate_destination_not_found": "找不到目的地",
        "affiliate_link_unavailable": "合作链接暂时无法使用",
...
ERROR_DETAILS: dict[Locale, dict[str, str]] = {
    "en": {
        **OAUTH_ERROR_DETAILS["en"],
        ...
        "catalog_relation_invalid": (
            "The candidate references invalid or ineligible foods or categories"
        ),
        "catalog_review_budget_exhausted": "Today's Gemini safety budget is exhausted",
        "catalog_review_incomplete": "Not all snapshot items have been assessed yet",
        "catalog_review_required": "Assess the existing pending catalog before adding candidates",
        "catalog_review_unconfigured": "A Gemini API key has not been configured",
        "catalog_run_in_progress": "Another catalog review is active. View or resume it first",
        "catalog_run_not_found": "This catalog review run could not be found",
        "catalog_run_not_resumable": (
            "This run cannot be resumed, or it has reached its call limit"
        ),
        "catalog_source_required": "The new candidate needs a traceable source",
        "catalog_source_invalid": "The new candidate has an unsupported or invalid source URL",
        "catalog_version_conflict": "The run has changed. Reload the review preview",
        "gemini_not_configured": "Configure the Gemini API key in the admin settings first",
        "idempotency_conflict": "The same idempotency key cannot be used for a different request",
        "invalid_catalog_category": "The new attraction candidate has an invalid category",
        "invalid_catalog_draft": "The new candidate has an invalid destination or slug",
        "invalid_catalog_relations": "The new candidate has invalid or missing related records",
    ...
    "ja": {
        **OAUTH_ERROR_DETAILS["ja"],
        ...
        "catalog_relation_invalid": (
            "候補に紐づく料理やカテゴリが無効か、利用条件を満たしていません"
        ),
        "catalog_review_budget_exhausted": "本日の Gemini の安全利用枠を使い切りました",
        "catalog_review_incomplete": "スナップショットの全項目の評価がまだ終わっていません",
        "catalog_review_required": "候補を追加する前に、既存の審査待ちデータを評価してください",
        "catalog_review_unconfigured": "Gemini API キーが設定されていません",
        "catalog_run_in_progress": "別の目録審査が実行中です。先に確認または再開してください",
        "catalog_run_not_found": "この目録審査処理が見つかりません",
        "catalog_run_not_resumable": "この処理は再開できないか、呼び出し回数の上限に達しています",
        "catalog_source_required": "新しい候補には追跡可能な情報源が必要です",
        "catalog_source_invalid": "新しい候補の情報源 URL は未対応か、形式が正しくありません",
        "catalog_version_conflict": (
            "処理の状態が変わりました。審査プレビューを再読み込みしてください"
        ),
        "gemini_not_configured": "先に管理設定で Gemini API キーを設定してください",
        "idempotency_conflict": "同じ冪等性キーを異なるリクエストに使用することはできません",
        "invalid_catalog_category": "新しい観光スポット候補のカテゴリが正しくありません",
        "invalid_catalog_draft": "新しい候補の目的地または slug が正しくありません",
        "invalid_catalog_relations": "新しい候補の関連データが正しくないか、存在しません",
    ...
    "ko": {
        **OAUTH_ERROR_DETAILS["ko"],
        ...
        "catalog_relation_invalid": (
            "후보에 연결된 음식이나 분류가 잘못되었거나 사용 조건을 충족하지 않습니다"
        ),
        "catalog_review_budget_exhausted": "오늘의 Gemini 안전 사용 한도를 모두 사용했습니다",
        "catalog_review_incomplete": "스냅샷의 모든 항목에 대한 평가가 아직 끝나지 않았습니다",
        "catalog_review_required": "후보를 추가하기 전에 기존 검토 대기 목록을 평가하세요",
        "catalog_review_unconfigured": "Gemini API 키가 설정되지 않았습니다",
        "catalog_run_in_progress": "다른 목록 검토가 진행 중입니다. 먼저 확인하거나 재개하세요",
        "catalog_run_not_found": "이 목록 검토 작업을 찾을 수 없습니다",
        "catalog_run_not_resumable": "이 작업은 재개할 수 없거나 호출 한도에 도달했습니다",
        "catalog_source_required": "새 후보에는 추적 가능한 출처가 필요합니다",
        "catalog_source_invalid": "새 후보의 출처 URL을 지원하지 않거나 형식이 올바르지 않습니다",
        "catalog_version_conflict": "작업 상태가 변경되었습니다. 검토 미리보기를 새로 불러오세요",
        "gemini_not_configured": "먼저 관리자 설정에서 Gemini API 키를 설정하세요",
        "idempotency_conflict": "같은 멱등성 키를 다른 요청에 사용할 수 없습니다",
        "invalid_catalog_category": "새 관광지 후보의 분류가 올바르지 않습니다",
        "invalid_catalog_draft": "새 후보의 목적지 또는 slug가 올바르지 않습니다",
        "invalid_catalog_relations": "새 후보의 관련 데이터가 올바르지 않거나 존재하지 않습니다",
    ...
    "zh-CN": {
        **OAUTH_ERROR_DETAILS["zh-CN"],
        ...
        "catalog_review_budget_exhausted": "今天的 Gemini 安全预算已用完",
        "catalog_review_incomplete": "尚未完成所有快照项目的评估",
        "catalog_review_required": "新增候选前必须先完成现有待审目录的评估",
        "catalog_review_unconfigured": "尚未设置 Gemini API Key",
        "catalog_run_in_progress": "已有其他目录审核正在运行，请先查看或继续该任务",
        "catalog_run_not_found": "找不到这次目录审核任务",
        "catalog_run_not_resumable": "当前任务不能继续运行，或已达到单次任务的调用上限",
        "catalog_source_required": "新候选需要可追溯的来源",
        "catalog_source_invalid": "新候选的来源网址不受支持或格式不合法",
        "catalog_version_conflict": "任务状态已改变，请重新加载审核预览",
        "gemini_not_configured": "请先在后台设置 Gemini API Key",
        "idempotency_conflict": "同一个幂等键不能用于不同请求",
        "invalid_catalog_category": "新景点候选的分类不合法",
        "invalid_catalog_draft": "新候选的目的地或 slug 不合法",
        "invalid_catalog_relations": "新候选的关联数据不合法或不存在",
...
_NEWS_AUTOMATION_ERRORS: dict[Locale, dict[str, str]] = {
    "en": {
        "news_article_already_published": "This news article already has a published version",
        ...
        "news_evidence_insufficient": (
            "Publication requires two evidence sources, including one first-party source"
        ),
        "news_gate_not_met": "This category has not met the automatic-publication gate",
        "news_hard_checks_failed": "The required format or editorial checks did not pass",
        "news_locale_bundle_incomplete": "All five language versions must be complete",
        "news_locale_review_required": "All five language versions must pass locale review",
        "news_mode_shadow": "Automatic publication cannot be enabled in shadow mode",
        "news_scanner_disabled": "The global news scanner is disabled",
        "news_slug_conflict": "This news page address is already in use",
        "news_source_detail_unreadable": "The source list is readable, but its article page is not",
        "news_source_disabled": "This source is disabled; validate it before scanning",
        "news_source_exists": "This news source already exists",
        "news_source_in_use": "This source has candidate history and can only be disabled",
        "news_source_not_found": "This news source could not be found",
        "news_source_role_invalid": "A first-party source must have the evidence role",
        "news_source_unreadable": "The source is reachable, but no news items can be read",
        "news_source_validation_failed": "The source failed its safety or readability check",
        "news_topic_unavailable": "The required news topic is not available",
        "news_verification_required": "Verify this article before publishing it",
        "news_verification_stale": "The Traditional Chinese draft changed; verify it again",
    },
    "ja": {
        "news_article_already_published": "このニュース記事には公開済みの版があります",
        ...
        "news_evidence_insufficient": "公開には一次情報を含む2件の証拠情報源が必要です",
        "news_gate_not_met": "この分類は自動公開の基準を満たしていません",
        "news_hard_checks_failed": "必須の形式または編集チェックに合格していません",
        "news_locale_bundle_incomplete": "5言語すべての版を完成させてください",
        "news_locale_review_required": "5言語すべてで言語レビューに合格する必要があります",
        "news_mode_shadow": "シャドーモードでは自動公開を有効にできません",
        "news_scanner_disabled": "ニューススキャナーの全体設定が無効です",
        "news_slug_conflict": "このニュースページのアドレスは既に使用されています",
        "news_source_detail_unreadable": "情報源一覧は読めますが、記事本文を取得できません",
        "news_source_disabled": "この情報源は無効です。スキャン前に検証してください",
        "news_source_exists": "このニュース情報源は既に登録されています",
        "news_source_in_use": "候補履歴があるため、この情報源は無効化のみ可能です",
        "news_source_not_found": "このニュース情報源が見つかりません",
        "news_source_role_invalid": "一次情報には evidence の役割が必要です",
        "news_source_unreadable": "接続できましたが、ニュース項目を読み取れません",
        "news_source_validation_failed": "情報源の安全性または可読性チェックに失敗しました",
        "news_topic_unavailable": "必要なニューストピックを利用できません",
        "news_verification_required": "公開前にこの記事を検証してください",
        "news_verification_stale": "繁体字中国語の原稿が変更されました。再検証してください",
    },
    "ko": {
        "news_article_already_published": "이 뉴스 기사에는 이미 게시된 버전이 있습니다",
        ...
        "news_evidence_insufficient": "게시하려면 1차 출처를 포함한 근거 출처 2개가 필요합니다",
        "news_gate_not_met": "이 분류는 자동 게시 기준을 충족하지 못했습니다",
        "news_hard_checks_failed": "필수 형식 또는 편집 검사를 통과하지 못했습니다",
        "news_locale_bundle_incomplete": "5개 언어 버전을 모두 완성해야 합니다",
        "news_locale_review_required": "5개 언어 버전이 모두 언어 검토를 통과해야 합니다",
        "news_mode_shadow": "섀도 모드에서는 자동 게시를 활성화할 수 없습니다",
        "news_scanner_disabled": "전체 뉴스 스캐너가 비활성화되어 있습니다",
        "news_slug_conflict": "이 뉴스 페이지 주소는 이미 사용 중입니다",
        "news_source_detail_unreadable": (
            "출처 목록은 읽을 수 있지만 기사 본문을 가져올 수 없습니다"
        ),
        "news_source_disabled": "이 출처는 비활성 상태입니다. 스캔 전에 검증해 주세요",
        "news_source_exists": "이 뉴스 출처는 이미 등록되어 있습니다",
        "news_source_in_use": "후보 기록이 있어 이 출처는 비활성화만 할 수 있습니다",
        "news_source_not_found": "이 뉴스 출처를 찾을 수 없습니다",
        "news_source_role_invalid": "1차 출처는 evidence 역할이어야 합니다",
        "news_source_unreadable": "출처에 연결했지만 뉴스 항목을 읽을 수 없습니다",
        "news_source_validation_failed": "출처의 안전성 또는 가독성 검사를 통과하지 못했습니다",
        "news_topic_unavailable": "필요한 뉴스 주제를 사용할 수 없습니다",
        "news_verification_required": "게시하기 전에 이 기사를 검증해 주세요",
        "news_verification_stale": "번체 중국어 초안이 변경되었습니다. 다시 검증해 주세요",
    },
    "zh-TW": {
        "news_article_already_published": "這篇新聞已有公開版本",
        ...
        "news_evidence_insufficient": "發布需要兩個證據來源及一個第一方來源",
        "news_gate_not_met": "這個分類尚未達到自動發布門檻",
        "news_hard_checks_failed": "硬性格式或編輯政策檢查未通過",
        "news_locale_bundle_incomplete": "五個語言版本必須完整",
        "news_locale_review_required": "五個語言都必須通過語系檢查",
        "news_mode_shadow": "影子模式不能開啟自動發布",
        "news_scanner_disabled": "全域新聞掃描尚未啟用",
        "news_slug_conflict": "這個新聞網址代稱已被使用",
        "news_source_detail_unreadable": "來源清單可讀，但無法擷取新聞內頁內容",
        "news_source_disabled": "來源尚未啟用，請先驗證再掃描",
        "news_source_exists": "這個新聞來源已存在",
        "news_source_in_use": "來源已有候選紀錄，只能停用",
        "news_source_not_found": "找不到新聞來源",
        "news_source_role_invalid": "第一方來源必須設定為 evidence",
        "news_source_unreadable": "來源可以連線，但無法讀出新聞項目",
        "news_source_validation_failed": "來源未通過安全或內容可讀性檢查",
        "news_topic_unavailable": "新聞主題尚未建立",
        "news_verification_required": "請先查核文章再發布",
        "news_verification_stale": "繁中草稿已修改，請重新查核",
    },
    "zh-CN": {
        "news_article_already_published": "这篇新闻已有公开版本",
        ...
        "news_evidence_insufficient": "发布需要两个证据来源及一个第一方来源",
        "news_gate_not_met": "这个分类尚未达到自动发布门槛",
        "news_hard_checks_failed": "硬性格式或编辑政策检查未通过",
        "news_locale_bundle_incomplete": "五个语言版本必须完整",
        "news_locale_review_required": "五个语言都必须通过语言检查",
        "news_mode_shadow": "影子模式不能开启自动发布",
        "news_scanner_disabled": "全局新闻扫描尚未启用",
        "news_slug_conflict": "这个新闻页面地址已被使用",
        "news_source_detail_unreadable": "来源列表可读，但无法提取新闻内页内容",
        "news_source_disabled": "来源尚未启用，请先验证再扫描",
        "news_source_exists": "这个新闻来源已存在",
        "news_source_in_use": "来源已有候选记录，只能停用",
        "news_source_not_found": "找不到新闻来源",
        "news_source_role_invalid": "第一方来源必须设置为 evidence",
        "news_source_unreadable": "来源可以连接，但无法读取新闻项目",
        "news_source_validation_failed": "来源未通过安全或内容可读性检查",
        "news_topic_unavailable": "新闻主题尚未建立",
        "news_verification_required": "请先核查文章再发布",
        "news_verification_stale": "繁体中文草稿已修改，请重新核查",
    },
}
for _news_locale, _news_errors in _NEWS_AUTOMATION_ERRORS.items():
