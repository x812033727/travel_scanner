...
export default function Home() {
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-5 py-7 md:px-8">
      <header className="flex items-center justify-between">
        ...
        <nav className="flex gap-5 text-sm text-[var(--muted)]"><Link href="/pricing">方案</Link><Link href="/login">登入</Link></nav>
      </header>
      <section className="grid gap-10 py-20 lg:grid-cols-[1fr_.9fr] lg:items-center">
        ...
        <form action="/search" className="rounded-[2rem] border border-[var(--line)] bg-white p-7 shadow-[0_24px_80px_rgba(16,42,43,.12)]">
