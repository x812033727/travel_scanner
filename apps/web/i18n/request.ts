...
const namespaces = ["common", "metadata", "navigation", "auth", "search", "trips", "alerts", "pricing", "usage", "account", "admin", "availability", "errors", "legacy", "hotspots", "hotspotAdmin", "foods", "foodAdmin"] as const;
