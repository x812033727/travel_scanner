...
const labels = { heading: "依主題瀏覽", more: "更多子主題" };
...
describe("topic tiles", () => {
  ...
  it("shows the first three sub-topics with something under them and says there are more", () => {
    ...
    expect(screen.getByText("更多子主題")).toBeTruthy();
  });
