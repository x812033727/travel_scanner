...
export function RouteModePanel({
  ...
  return <div className="route-panel-layout">
    ...
    {activeSegment && <div className="route-panel-detail min-w-0 space-y-4"><RouteMap items={items} segment={activeSegment} fromItemId={fromItemId} toItemId={toItemId} travelMode={mode} variant="drawer" /><RouteSegmentCard segment={activeSegment} selected defaultExpanded /></div>}
