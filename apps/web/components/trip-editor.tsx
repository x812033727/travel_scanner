...
export function TripEditor({ tripId }: { tripId: string }) {
  ...
  async function computeRoutes(day: string, refresh = false) {
    ...
    try {
      ...
      setNotice(result.partial ? "已更新可取得的路線；部分地點尚未確認位置。" : "路線已更新，本次不扣次。");
