...
const en = {
  ...
  guidesTitle: "Intel and guides for this city",
  guidesIntel: "Latest travel intel",
  guidesHowto: "Guides and how-tos",
  ...
  unavailablePlaces: "Reviewed places are temporarily unavailable. Please try again later.",
  unavailableFood: "Reviewed merchants are temporarily unavailable. Please try again later.",
  partOf: "Part of",
...
const copies: Record<string, Copy> = {
  ...
  "zh-TW": {
    ...
    unavailablePlaces: "暫時無法取得已審核景點，請稍後再試。",
    unavailableFood: "暫時無法取得已審核店家，請稍後再試。",
    partOf: "屬於",
    extensions: "延伸目的地",
    breadcrumb: "目的地",
  },
  "zh-CN": {
    ...
    unavailablePlaces: "暂时无法获取已审核景点，请稍后再试。",
    unavailableFood: "暂时无法获取已审核商家，请稍后再试。",
    partOf: "属于",
    extensions: "延伸目的地",
    breadcrumb: "目的地",
  },
  ja: {
    ...
    unavailablePlaces: "確認済みスポットを一時的に取得できません。時間をおいて再度お試しください。",
    unavailableFood: "確認済み店舗を一時的に取得できません。時間をおいて再度お試しください。",
    partOf: "所属",
    extensions: "拡張エリア",
    breadcrumb: "旅行先",
  },
  ko: {
    ...
    guidesTitle: "이 도시의 소식과 가이드",
    guidesIntel: "최신 여행 소식",
    guidesHowto: "가이드와 안내",
    planTrip: "항공권과 숙소 비교하기",
    stays: "이 여행지의 숙소",
    emptyPlaces: "이 여행지의 검증된 장소가 아직 없습니다.",
    emptyFood: "이 여행지의 검증된 매장이 아직 없습니다.",
    unavailablePlaces: "검증된 장소를 일시적으로 불러올 수 없습니다. 나중에 다시 시도해 주세요.",
    unavailableFood: "검증된 매장을 일시적으로 불러올 수 없습니다. 나중에 다시 시도해 주세요.",
    partOf: "소속",
    extensions: "확장 여행지",
    breadcrumb: "여행지",
  },
