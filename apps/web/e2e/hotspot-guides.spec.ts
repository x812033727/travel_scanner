...
for (const width of [320, 390]) {
  test(`mobile guide sheet is app-like at ${width}px`, async ({ page }) => {
    ...
    await expect(dialog.getByRole("link", { name: "官方網站" })).toHaveAttribute("href", "https://www.senso-ji.jp/");
