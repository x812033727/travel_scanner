...
- [ ] No request to the Drive script's host is made on `/{locale}/share/{token}` in any locale.
- [ ] Public content pages (articles, destinations) keep the script and its DNT/GPC opt-out.
- [ ] A component test covers a share path.

## Steps

- [ ] Use the same mechanism as `2026-09-23-third-party-scripts-on-privileged-routes`
...
- [ ] Add `/share/` to the excluded paths and a test for it.
