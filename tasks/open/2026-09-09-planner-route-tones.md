...
- [ ] Applied route stays selected after version updates; preview/apply remain explicit.
- [ ] Idle/loading/preview/applied/stale/external/error states are truthful and concise.
- [ ] Selected path availability controls schematic map messaging.
- [ ] Hotel blue, lunch amber and dinner violet work in collapsed, expanded and optional rows in both themes.
...
- [ ] Parent route synchronization and integration regression.
- [ ] Route panel/map state and scoped layout.
- [ ] Shared role tones and system-card semantics.
