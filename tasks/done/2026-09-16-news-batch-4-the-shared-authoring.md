...
- [x] 幣圈 11 則、科技 12 則已驗，**兩個垂直的重要新聞都到量**；AI 2 則已驗＋13 則已確認日期。
- [x] 站主裁定 **Apple M6／M5 Ultra（8/25）從次要新聞升級為重要新聞**，成為科技的 T8。
- [ ] 各垂直還缺 4–6 則「次要新聞」。科技 8 則、AI 8 則已列候選，**幣圈 0 則**。
...
## 第五輪：M6 升級為重要新聞（claude-opus-5, 2026-09-16）

站主裁定 **Apple M6 與 M5 Ultra（2026-08-25）從「次要新聞」升級為「重要新聞」**。
候選清單裡那一則從次要新聞那一節移進已驗區，成為 **T8**，科技的重要新聞來到 **12 則**。
...
- **一條額外的界線**：Apple 的效能倍數只跟自家前代比，
  **不要拿去跟其他廠商的晶片比較**，官方沒有做那個比較。

官方數字原封不動照抄，沒有重寫：M6 是 12 核 CPU／12 核 GPU／雙 16 核神經網路引擎、
頻寬 170GB/s、記憶體最高 32GB、「up to 1.2x faster multithreaded performance as
compared to M5」；M5 Ultra 是最高 36 核 CPU／80 核 GPU／32 核神經網路引擎、
頻寬 1.2TB/s、記憶體最高 512GB、「up to 1.3x higher multithreaded performance than
M3 Ultra」。**官方沒說售價與上市日期**，兩項都要寫成「官方未說明」。

**方向相反的那一則沒有一起動**：T7 September Pixel Drop 份量偏輕，
清單上仍標著「建議當次要新聞」，等站主圈選時一併決定。

科技的次要新聞因此仍是 8 則（Apple Developer 四則、Windows 一則、NVIDIA 兩則、
加 T7），M6 本來就沒有計入那 8 則，所以次要新聞的數量沒有變。
