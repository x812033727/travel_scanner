...
completed_at: 2026-09-12T02:04:09Z
...
- [x] PR #408 合併、部署 `02317cf5`、容器內試跑後經擁有者確認才套用。實際寫入 311 筆
  （新建 190、更新 121、跳過 0），稽核 311 筆；有訂位按鈕的公開店家 35 → 45 間，
  Song Fa 的 Chope 按鈕下架，人工審核的 36 列未被更動；前台 `/zh-TW/foods` 已看到按鈕。
...
- 因封鎖而未確認的項目已歸零。台南翰林茶館赤崁店最後一次重試打開了 inline 品牌頁：翰林的 inline
  線上訂位只列高雄時代店、新竹遠百巨城店、台北車站店，沒有台南赤崁門市，所以那筆是 inline 查無本分店
  （`not_found`）；本店在 OpenRice 另有頁面，只能電話訂位，記為停用。
- 台北春水堂信義店與 SIDOLI RADIO 原本也卡在同一個封鎖，後來低頻率單頁重試就打得開了：兩頁都確認是本店，
  但都明寫「目前尚不開放線上訂位」，已改記為停用。封鎖是短時間大量開頁觸發的，隔一段時間就會解除。
