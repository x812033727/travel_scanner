...
**48 open · 2 in progress · 3 blocked · 0 in review · 237 done**
...
| P2 | [Wire /guides into the footer and destination pages](open/2026-09-11-guides-sitemap-and-entry-points.md) | web | `apps/web/components/site-footer.tsx`<br>`apps/web/components/site-footer.test.tsx`<br>`apps/web/components/destination-guide.tsx`<br>`apps/web/components/destination-guide.test.tsx`<br>`apps/web/lib/discovery-copy.ts` |
