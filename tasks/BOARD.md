...
**26 open · 7 in progress · 0 blocked · 0 in review · 28 done**
...
| --- | --- | --- | --- |
| [Consolidate AI vendor keys, model catalog and per-feature models (API)](open/2026-09-06-ai-settings-api.md) | claude-fable-5-1 | 2026-09-06T06:23:36Z | `claude/ai-settings-consolidation` |
| [AI settings in the admin panel: vendor card, model dropdowns, per-feature models (web)](open/2026-09-06-ai-settings-web.md) | claude-fable-5-1 | 2026-09-06T06:23:38Z | `claude/ai-settings-consolidation` |
...
| [Admin help text tells operators to avoid the model now shipped](open/2026-09-06-stale-gemini-model-help.md) | claude-fable-5-1 | 2026-09-06T06:23:09Z | `claude/ai-settings-consolidation` |
...
| --- | --- | --- |
| P2 | [482 個景點卡在人工審核佇列](open/2026-09-06-hotspot-review-backlog.md) | active work in the same scope |
...
| P3 | [註冊關閉頁的小標與 H1 是同一句話](open/2026-09-06-auth-duplicate-heading.md) | active work in the same scope |
