...
- **⚠️ 這一行原本寫錯了，2026-09-16 查核更正。** 原文寫「官方沒有逐一列出那 70 多個
  地區，不可推定台灣在內」——**後半是錯的**。Apple **繁體中文版新聞稿把台灣明確列在
  首波**：「…韓國、泰國、台灣、阿聯酋、英國、美國和越南等超過 63 個國家和地區」。
  要寫成「Apple 繁體中文版新聞稿列入首波」，**不是**「官方未列出」。
- **兩個官方版本互相矛盾，必須並列、不可挑一個寫**：英文版寫「超過 70 個」，
  繁體中文版寫「超過 63 個」。同日的 iPhone 18 Pro 兩版都寫 65，所以這不是慣例差異。
- **漏了第二波**：另有 28 個國家與地區自 **2026-10-30** 起供貨。
- **⚠️ Apple 繁中新聞稿會吃掉英文的 up to**，照抄繁中會寫出比官方更強的斷言：
  繁中「6 核心 CPU 比 A19 Pro 快了 20%」vs 英文 up to 20 percent faster；
  繁中「其剛度比業界其他採用的材質高出 40%」vs 英文 up to 40 percent higher stiffness；
  最嚴重的是繁中「7 核心 GPU 速度和能源效率都提升了 40%」——**英文的 40% 只掛在速度上**
  （up to 40 percent faster and more power efficient）。三個數字照抄繁中都會錯。
- **⚠️ 繁中把充電數字配錯了**：繁中寫「搭配 MagSafe 或 Qi2 充電器，約 20 分鐘充至最多
  50%」，但英文與繁中規格頁都是**有線 20 分鐘、MagSafe／Qi2 無線 30 分鐘**。
- **「混合使用 24 小時」不是影片續航**，原文是 up to 24 hours of usage per charge。
- **Ceramic Shield 2 要寫位置**：正面／外螢幕是 Ceramic Shield 2，背板是一般 Ceramic
  Shield，內螢幕是抗刮鍍膜加特製聚合物奈米紋理層。**不要寫成「內螢幕不是 Ceramic
  Shield 2」**——官方沒有這樣說，那是從沉默推論出來的。
- **台灣讀者最該知道的兩件事，候選清單原本都沒有**：台灣定價 **NT$74,900 起**；
  **eSIM 專用、台灣沒有實體 SIM 卡槽**（繁中版點名中華電信、台灣大哥大、遠傳電信）。
  後者對台灣讀者比螢幕尺寸實際得多。
- 預購台灣時間是 **10 月 16 日（五）晚上 8 點**。美金 83.29 月付要寫條件：
  ACMI 分期、須選 AT&T／T-Mobile／Verizon、須過信用審核。
