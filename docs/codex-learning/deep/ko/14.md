...
core.mjs의 visibleTasks 전체를 선택하고 명령 팔레트의 Add to Codex Thread로 현재 작업에 추가합니다. 실제 확장 버전에 제공되는 명령을 확인하세요. core.test.mjs도 열고 전송 전 파일/선택 표시가 의도한 두 파일인지 확인합니다. 비슷한 이름의 다른 사본과 혼동하지 마세요.
