...
```shell 터미널 명령: codex-first-site 폴더에서 실행
...
```powershell Windows PowerShell: 실습 폴더에서 로컬 미리보기 시작
...
```bash macOS/Linux 터미널: 실습 폴더에서 로컬 미리보기 시작
...
```text 웹페이지 입력값: 할 일 입력란에 붙여 넣고 추가
<img src=x>
```
