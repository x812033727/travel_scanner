...
桌面版開啟本 Git 專案，在 review 面板先看未暫存差異，再於輸入框輸入 /review，選 Review uncommitted changes。CLI 也在 Codex 互動輸入框使用 /review 並選未提交修改；不是把 /review 打在系統 shell。此處還沒 commit，所以只審某個已提交版本會漏掉剛剛的 reverse。
