...
> 用三次新 CLI 工作階段比較根目錄、子目錄與 override 規則，找出為什麼某條 AGENTS.md 沒有生效。閱讀約 12 分鐘，操作約 25 分鐘。先完成 CLI 與 AGENTS.md 入門；需要 Git、文字編輯器及可用的 Codex 登入。Windows、macOS、Linux 的規則檔內容相同，終端機路徑操作依系統分開。
