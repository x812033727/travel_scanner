...
The materials are an original, shareable fictional website. Reference core and browser behavior were verified on Windows/Edge; other OS startup instructions are not claimed as hands-on tests. Codex entry points were checked on 2026-09-20 against the [official quickstart](https://learn.chatgpt.com/docs/quickstart) and [CLI documentation](https://learn.chatgpt.com/docs/codex/cli). Images illustrate exercise results, not Codex product UI.
