...
開始状態は2件成功、1件失敗です。教材の故障なのでテストを弱めません。index.html で Read と Build を追加し Read を完了、Active / Completed を切り替えると両方とも全件表示します。違う場合は broken や expected ではなく start かを確認します。
