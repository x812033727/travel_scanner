...
教材はこのシリーズ独自の公開共有可能な架空サイトです。参考版の基本動作とブラウザー動作は Windows/Edge で検証し、他 OS の起動説明を実機試験と称していません。入口は 2026-09-20 の[公式クイックスタート](https://learn.chatgpt.com/docs/quickstart)と [CLI 文書](https://learn.chatgpt.com/docs/codex/cli)で確認しました。画像は練習成果で Codex UI ではありません。
