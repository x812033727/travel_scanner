...
すべて保存し codex-docs-lab で新規課題を開きます。次の依頼で handoff.md だけの変更を許可し、ソース、テスト、規則を保持します。唯読で更新できなければ読取りとテストを確認して手で記録するか、[権限記事](article:codex-permissions)で必要範囲を調整します。
