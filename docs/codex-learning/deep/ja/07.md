...
目標を「ボタンだけ Create task にし、placeholder は原文のまま」に変えて自分で依頼を書きます。index.html の唯一の変更文字を示し、追加、空入力、再読込を検証します。終了後は expected 原本から index.html だけを戻し、Python は Ctrl+C で止めます。Codex の会話を閉じても文言変更は元に戻りません。
