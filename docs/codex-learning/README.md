...
下一輪補強從[深入製作與驗收總目錄](deepening/README.md)開始：十份單元文件包含 60 篇獨立規格，每篇明列材料、操作、交付物、成功／失敗、還原與圖片需求，並連回現有作者稿及五語內容包。[共同驗收表](deepening/review-checklist.md)列出五篇代表稿及六組十篇的檢查順序；規劃完成不改變最終驗收狀態。
