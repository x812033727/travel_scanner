...
已補強 A 至 E 單元的 26 篇，加上原五篇代表稿，共 **31 篇有定向補強，29 篇待逐篇核對**。最新 [E 審核紀錄](evidence/unit-e-depth-review.json)包含 CLI 分岔、壓縮後交接、模型比較條件、計畫修訂與權限證據；[C](evidence/unit-c-depth-review.json)、[D 紀錄](evidence/unit-d-depth-review.json)保留手機、跨裝置、Markdown 及設定補強。下一單元為 F，全部仍待完整五語終審與最終頁面驗收。
