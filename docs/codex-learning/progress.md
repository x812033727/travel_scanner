...
依本輪「繼續規劃深入教學」要求，新增[深入製作與驗收總目錄](deepening/README.md)、十份單元規格與[共同驗收表](deepening/review-checklist.md)。60 篇逐篇連到既有作者稿與五語內容包，寫明材料、操作、產物、成功、失敗／邊界、還原及圖片要求；沒有新增重複文章或更改 ID／slug。

接下來先審 03／10／04／11／23 五篇代表稿，再依閱讀次序每十篇檢查一次，維持三大批各二十篇。此輪只完成規劃文件，沒有重跑產品操作、變更文章內容或取得新的瀏覽器證據；正式深入驗收仍為 0/60。
