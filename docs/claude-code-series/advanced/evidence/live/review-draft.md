...
實體手機、遠端 MCP OAuth、支援平台 Bash sandbox 和付費 Actions 模型工作仍有待驗證範圍，逐項列於 tasks/open/2026-09-14-claude-advanced-live-validation.md。claude-lab 已建立並限制 main，但尚無 ANTHROPIC_API_KEY。本 PR 不執行正式部署、資料庫匯入或公開發布。
