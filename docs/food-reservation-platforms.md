...
The shared known-provider catalog contains TableCheck, Catchtable Global, EZTABLE, Chope, OpenRice, Hungry Hub, PasGo, inline, Maifood, SevenRooms, 一休, and My Concierge Japan. Existing reviewed links remain supported. No arbitrary provider or user-supplied host is accepted.
