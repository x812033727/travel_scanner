...
- **inline 擋機器人**：只剩台南翰林茶館赤崁店的 inline 品牌頁仍被「按住不放」驗證擋下（沒有破解），維持「無法確認」。翰林另外在 OpenRice 有本分店的頁面，只能電話訂位，已記為停用。
- 台北春水堂信義店與 SIDOLI RADIO 原本也卡在同一個封鎖，後來低頻率單頁重試就打開了。兩頁都確認是本店（春水堂：台北信義新天地 A9 店 B1F、022723-9913，與官網信義店松壽路9號B1、02-27239913 相符；SIDOLI：長安西路245號1樓，與官網 245號1F 相符），但都明寫「目前尚不開放線上訂位」，已改記為停用。
- 這類封鎖是短時間大量開頁觸發的，不是內建瀏覽器打不開這些站：同一個瀏覽器隔一段時間單頁重試，OpenRice 的 15 筆與 inline 的 3 頁都順利查完。
